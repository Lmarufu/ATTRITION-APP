...
if authentication_status == True:
    ...
    def main():
        ...
        st.markdown("[![GitHub](https://img.shields.io/badge/GitHub-View%20on%20GitHub-blue?logo=GitHub)](https://github.com/Lmarufu/Customer-Churn-Prediction-App)")
 
        st.subheader('Social Handles')
        st.write("""
        Connect with me on social media:
        - [GitHub](https://github.com/Lmarufu) 🐙
        - [LinkedIn](https://www.linkedin.com/in/loveness-marufu) 💼
        """)
